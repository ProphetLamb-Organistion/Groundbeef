...
namespace Groundbeef.Reflection
{
    ...
    public static class CollectionsReflect
    {
        ...
        public static IEnumerable Cast(this IEnumerable source, Type resultType)
        {
            ...
            return (IEnumerable)(castMethod(null, new object[] { source }) ?? throw new InvalidCastException());
        }
        #endregion
        ...
        {
            return (IList)(MakeListCtor(elementType).Invoke(null, null) ?? throw new NullReferenceException(ExceptionResource.CTOR_INVOKE_FAILED));
        }
        ...
        {
            return (IList)(MakeListCtor(elementType, new[] { typeof(int) }).Invoke(null, new object[] { capacity }) ?? throw new NullReferenceException(ExceptionResource.CTOR_INVOKE_FAILED));
        }
        ...
        {
            return (IList)(MakeListCtor(elementType, new[] { typeof(IEnumerable<>).MakeGenericType(elementType) }).Invoke(null, new object[] { collection }) ?? throw new NullReferenceException(ExceptionResource.CTOR_INVOKE_FAILED));
        }
