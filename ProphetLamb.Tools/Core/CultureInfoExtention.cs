...
namespace ProphetLamb.Tools.Core
{
    ...
    {
        private static MethodInfo VerifyCultureName__CultureInfo_Bool = typeof(CultureInfo).GetMethod("VerifyCultureName", new[] { typeof(CultureInfo), typeof(bool) }),
        ...
        public static bool VerifyCultureName(this CultureInfo culture, bool throwException)
        {
        ...
        /// <exception cref="ArgumentException"></exception>
        public static bool VerifyCulureName(string cultureName, bool throwException)
        {
