...
namespace Groundbeef.Collections.BitCollections
{
    public abstract class BitArrayList : IReadOnlyCollection<bool>, ICollection
    {
        ...
        {
            if (array.Rank != 1)
                throw new ArgumentException("Multirank arrays are not supported.");
            if (array.GetLowerBound(0) != 0)
                throw new ArgumentException("The lower bound has to be zero.");
            ...
            if (array is bool[] boolean)
                ...
                throw new ArgumentException("The type of the elements of the array is not boolean or unsigned 64 bit integer.");
        }
