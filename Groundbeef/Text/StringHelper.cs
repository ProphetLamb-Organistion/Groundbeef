...
namespace Groundbeef.Text
{
    ...
    public static class StringHelper
    {
        ...
        public static object ToKeyValuePair(string self, Type keyType, Type valueType)
        {
            ...
            return keyValuePairMethod(null, s_toKeyValuePairParameters) ?? throw new NullReferenceException("Invoker failed to invoke.");
        }
        ...
        public static IDictionary ToDictionary(string self, Type keyType, Type valueType)
        {
            ...
            return (IDictionary)(dictionaryMethod(null, s_toDictionaryParameters) ?? throw new NullReferenceException("Invoker failed to invoke."));
        }
        ...
        private static object ToConvertibleTypeByAttribute(string value, Type convertibleType)
        {
            ...
            {
                fromString = (convertibleType.GetMethods().WithAttribute<FromString>().First() ?? throw new MissingMethodException("No method with the FromString attribute found")).Invoke;
...
#pragma warning restore CS8602 // Dereference of a possibly null reference.
                ...
                _ => throw new FormatException("Cannot convert to the type."),
            };
        }
        #endregion
        ...
        public static string KeyValuePairToString(object keyValuePair, Type type)
        {
            ...
            return (string)(fromKeyValuePairMethod(null, s_fromKeyValuePairParameters) ?? throw new NullReferenceException("Invoker failed to invoke."));
        }
        ...
        public static string DictionaryToString(object dictionary, Type type)
        {
            ...
            return (string)(fromDictionaryMethod(null, s_fromDictionaryParameters) ?? throw new NullReferenceException("Invoker failed to invoke."));
        }
        ...
        private static string FromConvertibleTypeByAttribute(object value, Type convertibleType)
        {
            ...
            {
                toString = (convertibleType.GetMethods().WithAttribute<ToString>().First() ?? throw new MissingMethodException("No method with the FromString attribute found")).Invoke;
                s_fromConvertibleTypeMethods.Add(convertibleType.GUID, toString);
            }
            s_fromConvertibleTypeByAttributeParameters[0] = value;
            return (string)(toString(null, s_fromConvertibleTypeByAttributeParameters) ?? throw new NullReferenceException("Invoker failed to invoke."));
        }
        ...
        public static string ConvertibleValueToString(in object value, Type type, in IFormatProvider? provider = null, in string? formatString = null, in ColorStyles colorStyles = ColorStyles.None)
        {
            ...
            return index switch
            {
                ...
                _ => throw new FormatException("Cannot convert from the type."),
            };
        }
        #endregion
